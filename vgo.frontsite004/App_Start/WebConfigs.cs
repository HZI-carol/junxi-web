    ...
    public static class WebConfigs
    {
        ...
        public static string LoginUrl
        {
            get
            {
                if (UseNewUserbackstage)
                {
                    return $"{ApiUrl}user/login?redirect_uri={HttpUtility.UrlEncode(WebConfigs.Config.url_user)}";
                }
        ...
        public static string RegisterUrl
        {
            get
            {
                if (UseNewUserbackstage)
                {
                    return $"{ApiUrl}user/register?redirect_uri={HttpUtility.UrlEncode(WebConfigs.Config.url_user)}";
                }
