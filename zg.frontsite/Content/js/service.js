(function () {
    ...
    var __service = function (baseUrl, token) {
        ...
        this.getProjectList = function (page, pageSize, data, success) {
            httpRequest({
                type: "GET",
                url: "api/zaigou/front/projects/" + page + "/" + pageSize,
                data: data,
                success: success
            })
        };
        ...
        this.getCompanyList = function (page, pageSize, data, success) {
            httpRequest({
                type: "GET",
                url: "api/zaigou/front/frontcompanys/" + page + "/" + pageSize,
                data: data,
                success: success
            })
        };
        ...
        this.getProjectPanoList = function (page, pageSize, data, success) {
            httpRequest({
                type: "GET",
                url: "api/zaigou/front/panos/" + page + "/" + pageSize,
                data: data,
                success: success
            })
        };
